...
import "./App.css"
import crosswordia from "./img/crosswordia_gaus.png"
...
function App() {
  return (
    <div className="App">
      ...
      <main>
        {/* <img src="{crosswordia}" alt="" /> */}
        <Container>
          <Row className="px-4 my-5">
            <Col sm={7}>
              <Image src="https://picsum.photos/900/400" fluid rounded className="" />
              {/* <Image src= fluid rounded className="" referrerpolicy="no-referrer" /> */}
            </Col>
            <Col sm={5}>
          ...
          <Row>
            <Col>
              <Card className="h-100" style={{ width: "18rem" }}>
                ...
                <Card.Img variant="top" src={crosswordia} />
                <Card.Body>
                ...
                <Card.Footer>
                  {/* <small className="text-muted">https://crosswordia.app/</small> */}
                  <small className="text-muted">
                    <a href="https://crosswordia.app/">https://crosswordia.app/</a>
                  </small>
                  {/* <div className="text-muted">https://crosswordia.app/</div> */}
                </Card.Footer>
              </Card>
            </Col>
            <Col>
